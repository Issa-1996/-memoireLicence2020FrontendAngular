...
export class MethodeService {
  ...
  baseUrlUser="http://127.0.0.1:8000/api/admin/users";
  ...
  deleteUserId(userFormData: any): Observable<User> {
    return this.httpClient.delete<User>('http://127.0.0.1:8000/api/admin/users'+'/' +  userFormData, {headers:this.headers});
  }
...
readTontine(page: any): Observable<Tontine[]> {
  return this.httpClient.get<Tontine[]>('http://127.0.0.1:8000/api/admin/tontines?_page='+page, {headers: {'Content-Type': 'application/json'}});
}
readOneTontine(id: number): Observable<Tontine[]> {
  return this.httpClient.get<Tontine[]>('http://127.0.0.1:8000/api/admin/tontines/'+id, {headers: {'Content-Type': 'application/json'}});
}
addTontine(profil: any): Observable<Tontine> {
  return this.httpClient.post<Tontine>('http://127.0.0.1:8000/api/admin/tontine', profil, {headers:this.headers});
}
/**
 * 
 * @param tour Tour
 ...
 */
 readOneTour(id: number): Observable<Tour[]> {
  return this.httpClient.get<Tour[]>('http://127.0.0.1:8000/api/admin/tours/'+id, {headers: {'Content-Type': 'application/json'}});
}
addTour(profil: any): Observable<Tour> {
  return this.httpClient.post<Tour>('http://127.0.0.1:8000/api/admin/tours', profil, {headers:this.headers});
}
tirage():Observable<User>{
  return this.httpClient.get<User>('http://127.0.0.1:8000/api/admin/tirage', {headers: {'content-Type': 'application/json'}})
}
 ...
 */
 addEpargnes(epargne: any): Observable<Epargne> {
  return this.httpClient.post<Epargne>('http://127.0.0.1:8000/api/admin/epargnes', epargne, {headers:this.headers});
}
readEpargnes(page: any): Observable<Epargne[]> {
  return this.httpClient.get<Epargne[]>('http://127.0.0.1:8000/api/admin/tontines/1/tours?_page='+page, {headers: {'Content-Type': 'application/json'}});
}
}
